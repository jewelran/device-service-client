  ...
  <div className=" ">
      ...
      <div className="row d-flex  container-fluid">
            ...
            <figcaption>
              <p>
                <span style={{ color: "white" }}>
                  ...
                  Vitae iure alias labore fugiat nulla voluptates fugit deserunt
                  molestias aliquid iusto. Natus quisquam voluptatem impedit aut
                  placeat, ratione{" "}
                </span>
              </p>
            </figcaption>
        ...
        <div className="col-md-3">
          ...
          <div className="text-white">
            <big>
              Signup for regular newsletter and stay upto <br /> date our latest
              news
            </big>
          </div>
          <div className="mt-4">
