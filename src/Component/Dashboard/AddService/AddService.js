        ...
        <div className="d-flex justify-content-center align-items-center ">
          ...
          <h2 className ="text-secondary mb-4">Your service Add Here</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              />
              <br />
              {errors.title && <span className = "text-danger">This title is required</span>}
              <br />
              <br />
              <input 
               className="w-75 p-2 shadow border rounded inputContainer"
              ...
              <br />
              {errors.price && <span className = "text-danger">This price is required</span>}
              <br />
              <br />
              <input 
               className="w-75 p-2 shadow border rounded inputContainer"
              ...
              <br />
              {errors.description && <span className = "text-danger">This description is required</span>}
              <br />
              <br />
              <input 
               onChange={imgHandle}
